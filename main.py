...
# Contexto para manejar hashing de contraseñas encriptación
pwd_context = CryptContext(schemes=["bcrypt"], deprecated="auto")

# Dependencia para obtener la sesión de base de datos enviar datos
def get_db():
    db = SessionLocal()
    try:
        yield db
...
# Ruta principal temporal - carga la plantilla base
